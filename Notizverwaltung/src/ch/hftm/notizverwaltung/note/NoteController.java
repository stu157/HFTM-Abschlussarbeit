...
import ch.hftm.notizverwaltung.image.ImageController;
import ch.hftm.notizverwaltung.image.ImageModel;
import ch.hftm.notizverwaltung.interfaces.*;
import ch.hftm.notizverwaltung.main.Main;
import ch.hftm.notizverwaltung.main.MainController;
import ch.hftm.notizverwaltung.url.UrlController;
...
public class NoteController implements Initializable, DialogCallBack 
{
	...
	void loadLinkSelection(Hyperlink hl)
	{
		...
		try {
			...
			AnchorPane ap = loader.load(getClass().getResource("/ch/hftm/notizverwaltung/url/Url.fxml").openStream());
			...
			stage.getIcons().add(new Image("ch/hftm/notizverwaltung/images/Icon.png"));
	...
	void loadImageSelection(ImageModel im)
	{
		...
		try {
			FXMLLoader loader = new FXMLLoader();
			AnchorPane ap = loader.load(getClass().getResource("/ch/hftm/notizverwaltung/image/Image.fxml").openStream());
	 ...
	 * @param callback callback-objekt
	 */
